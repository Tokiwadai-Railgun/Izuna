...
module.exports = {
    ...
    runInteraction: async (Izuna, interaction, guildSettings) => {
        ...
        const adminRole = interaction.guild.roles.cache.get(guildSettings.adminRole)
        if (adminRole) {
            channel.permissionOverwrites.create(adminRole, {"ViewChannel": true})
        }
        ...
        const ticketDetailEmbed = new EmbedBuilder()
            ...
            .setDescription("L'utilisateur souhaite signaler un membre du staff")
