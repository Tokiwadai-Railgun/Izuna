...
module.exports = {
    ...
    runInteraction: async (Izuna, interaction, guildSettings) => {
        ...
        if (!guildSettings.recrutementStatus === "on") return interaction.reply({ content: "Les candidatures sont actuellement fermés, contactez le staff pour plus de détail", ephemeral: true})
        ...
        const ticketDetailEmbed = new EmbedBuilder()
            ...
            .setDescription("L'utilisateur souhaite postuler")
